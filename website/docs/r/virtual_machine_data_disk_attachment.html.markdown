...
* `name` - (Optional) The name of this Disk Attachment, which needs to be unique within the Virtual Machine. If this isn't specified, the name of the Managed Disk will bs used. Changing this forces a new resource to be created.
